...
<div class="flex flex-col items-center justify-center w-full h-screen bg-gray-900 gap-2">
    <div class="inline-flex items-center gap-2">
        <img src="/baboon.png" alt="The project logo" class="h-12 w-12" />
        <p class="font-bold text-2xl">Baboon</p>
    </div>
